...
impl MapModel {
    ...
    pub fn collect_statistics(&self) -> MapStatistics {
        ...
        let mut stats = MapStatistics { tile_count: self.tiles.len() as u64, spawn_count: self.spawns.len() as u64, house_count: self.houses.len() as u64, waypoint_count: self.waypoints.len() as u64, town_count: self.towns.len() as u64, ..Default::default() };
