...
- `M023-sprite-rendering-parity` is complete: implemented `SpriteAtlas` CPU staging in Rust core, mapped WGSL sprite shaders, established PyO3 frame payload bridge, and refactored UI canvas with high-contrast diagnostic overlays and design system tokens.
## Blockers
