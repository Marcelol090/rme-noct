...
def test_main_window_persists_shell_state_with_qsettings(
    ...
    assert [int(value) for value in saved.value("main_window/position")] == [32000, 32000, 8]
    assert [int(value) for value in saved.value("main_window/previous_position")] == [
        32000,
        32000,
        7,
    ]
    ...
    assert restored._previous_position == (32000, 32000, 7)
