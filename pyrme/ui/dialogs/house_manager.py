...
class HouseManagerDialog(QDialog):
    ...
    def __init__(self, parent: MainWindow) -> None:
        ...
        self._can_list_houses = callable(getattr(self._editor, "get_houses", None))
        self._can_create_house = callable(getattr(self._editor, "add_house", None))
        self._can_update_house = callable(getattr(self._editor, "update_house", None))
        self._can_remove_house = callable(getattr(self._editor, "remove_house", None))
    ...
    def _build_layout(self) -> None:
        ...
        sidebar_title.setFont(TYPOGRAPHY.ui_label(11))
        ...
        self.add_btn.setEnabled(self._can_create_house)
        ...
        name_label.setFont(TYPOGRAPHY.ui_label(11))
        ...
        id_label.setFont(TYPOGRAPHY.ui_label(11))
        ...
        rent_label.setFont(TYPOGRAPHY.ui_label(11))
        ...
        town_label.setFont(TYPOGRAPHY.ui_label(11))
        ...
        self.guildhall_check.setFont(TYPOGRAPHY.ui_label(11))
        ...
        pos_label.setFont(TYPOGRAPHY.ui_label(11))
    ...
    def _refresh_town_filter(self) -> None:
        ...
        get_towns = getattr(self._editor, "get_towns", None)
        towns = get_towns() if callable(get_towns) else []
    ...
    def _on_selection_changed(self) -> None:
        ...
        self._enable_details(self._can_update_house)
        self.remove_btn.setEnabled(self._can_remove_house)
    ...
    def _on_data_changed(self) -> None:
        ...
        if self._selected_house_id is None or not self._can_update_house:
            return
        ...
        # Update Rust Core
        success = self._editor.update_house(
    ...
    def _on_remove_house(self) -> None:
        ...
        if self._selected_house_id is None or not self._can_remove_house:
            return
